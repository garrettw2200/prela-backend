        ...
        if spans:
            ...
            for span in spans:
                span_row = {
                    ...
                    "service_name": trace_data.get("service_name") or "unknown",
                    ...
                    "events": json.dumps(span.get("events") or []),
                    "replay_snapshot": json.dumps(span.get("replay_snapshot") or {}),
                    "source": "native",
                }
...
async def ingest_span(
    ...
    try:
        ...
        span_row = {
            ...
            "trace_id": trace_id,
            "project_id": project_id,
            "parent_span_id": span_data.get("parent_span_id") or "",
            "name": span_data.get("name") or "",
            "span_type": span_data.get("span_type") or "unknown",
            "service_name": span_data.get("service_name") or "unknown",
            ...
            "status": span_data.get("status") or "unknown",
            "attributes": json.dumps(span_data.get("attributes") or {}),
            "events": json.dumps(span_data.get("events") or []),
            "replay_snapshot": json.dumps(span_data.get("replay_snapshot") or {}),
            "source": "native",
        }
